import { $n as Output, Do as ɵɵgetInheritedFactory, Dr as ViewEncapsulation, Ec as Injector, El as ɵɵdefineInjector, En as ElementRef, Er as ViewContainerRef, Gs as ɵɵtextInterpolate1, Il as map, In as Input, Ll as BehaviorSubject, Mr as afterNextRender, O as booleanAttribute, Rl as Subject, Rs as ɵɵstyleProp, S as ViewChild, Sa as ɵɵconditional, Ta as ɵɵcontentQuery, Tc as InjectionToken, Ui as setClassMetadata, Us as ɵɵtext, Vs as ɵɵtemplate, Xo as ɵɵnextContext, Yo as ɵɵloadQuery, _o as ɵɵelementContainerEnd, _s as ɵɵqueryRefresh, a as ContentChildren, an as ChangeDetectionStrategy, ba as ɵɵclassProp, bo as ɵɵelementStart, ca as ɵɵNgOnChangesFeature, cn as Component, eo as ɵɵdefineComponent, f as HostAttributeToken, go as ɵɵelementContainer, i as ContentChild, is as ɵɵprojectionDef, la as ɵɵProvidersFeature, no as ɵɵdefineNgModule, oc as ɵɵviewQuery, ol as inject, p as IterableDiffers, pc as DOCUMENT, qn as NgModule, r as ChangeDetectorRef, rs as ɵɵprojection, sa as ɵɵInheritDefinitionFeature, to as ɵɵdefineDirective, ua as ɵɵadvance, vo as ɵɵelementContainerStart, vr as TemplateRef, wa as ɵɵconditionalCreate, wn as Directive, yc as EventEmitter, yo as ɵɵelementEnd } from "./core-Cj36f57E.js";
import { a as ViewportRuler, c as DataSource, d as animationFrameScheduler, f as asapScheduler, i as ScrollingModule, l as isDataSource, o as _RecycleViewRepeaterStrategy, s as _ViewRepeaterOperation, t as CDK_VIRTUAL_SCROLL_VIEWPORT } from "./scrolling-dPeORYh_.js";
import { i as Platform, t as _isNumberValue } from "./_element-chunk-DcYdKqvP.js";
import { r as merge } from "./shareReplay-HA9fjL2G.js";
import { i as of } from "./switchMap-CiPnbaeJ.js";
import { t as isObservable } from "./isObservable-BWvU4qXz.js";
import { t as auditTime } from "./auditTime-BvxwfbE6.js";
import { a as combineLatest, t as takeUntil } from "./takeUntil-BUWJqkiC.js";
...
var CdkCellDef = class CdkCellDef {
...
var CdkHeaderCellDef = class CdkHeaderCellDef {
	template = inject(TemplateRef);
...
var CdkFooterCellDef = class CdkFooterCellDef {
	template = inject(TemplateRef);
...
var CdkColumnDef = class CdkColumnDef {
...
var CdkHeaderCell = class CdkHeaderCell extends BaseCdkCell {
	constructor() {
...
var CdkFooterCell = class CdkFooterCell extends BaseCdkCell {
	constructor() {
...
var CdkCell = class CdkCell extends BaseCdkCell {
	constructor() {
		const columnDef = inject(CdkColumnDef);
		const elementRef = inject(ElementRef);
		super(columnDef, elementRef);
...
var BaseRowDef = class BaseRowDef {
	template = inject(TemplateRef);
...
var CdkHeaderRowDef = class CdkHeaderRowDef extends BaseRowDef {
	_table = inject(CDK_TABLE, { optional: true });
	_hasStickyChanged = false;
	get sticky() {
		return this._sticky;
	...
	static ɵfac = /* @__PURE__ */ (() => {
		...
		return function CdkHeaderRowDef_Factory(__ngFactoryType__) {
			return (ɵCdkHeaderRowDef_BaseFactory || (ɵCdkHeaderRowDef_BaseFactory = ɵɵgetInheritedFactory(CdkHeaderRowDef)))(__ngFactoryType__ || CdkHeaderRowDef);
		};
	})();
	static ɵdir = /* @__PURE__ */ ɵɵdefineDirective({
...
var CdkFooterRowDef = class CdkFooterRowDef extends BaseRowDef {
	_table = inject(CDK_TABLE, { optional: true });
	_hasStickyChanged = false;
	get sticky() {
		return this._sticky;
	...
	static ɵfac = /* @__PURE__ */ (() => {
		...
		return function CdkFooterRowDef_Factory(__ngFactoryType__) {
			return (ɵCdkFooterRowDef_BaseFactory || (ɵCdkFooterRowDef_BaseFactory = ɵɵgetInheritedFactory(CdkFooterRowDef)))(__ngFactoryType__ || CdkFooterRowDef);
		};
	})();
	static ɵdir = /* @__PURE__ */ ɵɵdefineDirective({
...
var CdkRowDef = class CdkRowDef extends BaseRowDef {
	_table = inject(CDK_TABLE, { optional: true });
	when;
	static ɵfac = /* @__PURE__ */ (() => {
		let ɵCdkRowDef_BaseFactory;
		return function CdkRowDef_Factory(__ngFactoryType__) {
			return (ɵCdkRowDef_BaseFactory || (ɵCdkRowDef_BaseFactory = ɵɵgetInheritedFactory(CdkRowDef)))(__ngFactoryType__ || CdkRowDef);
		};
	})();
	static ɵdir = /* @__PURE__ */ ɵɵdefineDirective({
		type: CdkRowDef,
...
var CdkHeaderRow = class CdkHeaderRow {
...
var CdkFooterRow = class CdkFooterRow {
...
var CdkNoDataRow = class CdkNoDataRow {
...
var StickyStyler = class {
	...
	stickRows(rowsToStick, stickyStates, position) {
		...
		afterNextRender({
			...
			write: () => {
				...
				if (position === "top") this._positionListener?.stickyHeaderRowsUpdated({
					sizes: stickyCellHeights,
					offsets: stickyOffsets,
					elements: elementsToStick
				});
				else this._positionListener?.stickyFooterRowsUpdated({
					sizes: stickyCellHeights,
					offsets: stickyOffsets,
					elements: elementsToStick
				});
	...
	_updateCachedSizes(entries) {
		...
		for (const entry of entries) {
			...
			if (newEntry.width !== this._elemSizeCache.get(entry.target)?.width && isCell(entry.target)) needsColumnUpdate = true;
...
var CdkRecycleRows = class CdkRecycleRows {
...
var DataRowOutlet = class DataRowOutlet {
...
var HeaderRowOutlet = class HeaderRowOutlet {
	viewContainer = inject(ViewContainerRef);
	elementRef = inject(ElementRef);
	constructor() {
		const table = inject(CDK_TABLE);
...
var FooterRowOutlet = class FooterRowOutlet {
	viewContainer = inject(ViewContainerRef);
	elementRef = inject(ElementRef);
	constructor() {
		const table = inject(CDK_TABLE);
...
var NoDataRowOutlet = class NoDataRowOutlet {
	viewContainer = inject(ViewContainerRef);
	elementRef = inject(ElementRef);
	constructor() {
		const table = inject(CDK_TABLE);
...
var CdkTable = class CdkTable {
	...
	_positionListener = inject(STICKY_POSITIONING_LISTENER, { optional: true }) || inject(STICKY_POSITIONING_LISTENER, {
		optional: true,
		skipSelf: true
	});
	...
	_addStickyColumnStyles(rows, rowDef) {
		const columnDefs = Array.from(rowDef?.columns || []).map((columnName) => {
			...
			if (!columnDef && (typeof ngDevMode === "undefined" || ngDevMode)) throw getTableUnknownColumnError(columnName);
			return columnDef;
		});
	...
	_getCellTemplates(rowDef) {
		...
		return Array.from(rowDef.columns, (columnId) => {
			...
			if (!column && (typeof ngDevMode === "undefined" || ngDevMode)) throw getTableUnknownColumnError(columnId);
...
var CdkTextColumn = class CdkTextColumn {
...
var CdkTableModule = class CdkTableModule {
	...
	static ɵinj = /* @__PURE__ */ ɵɵdefineInjector({ imports: [ScrollingModule] });
};
(() => {
	(typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CdkTableModule, [{
		...
		args: [{
			...
			imports: [ScrollingModule, ...EXPORTED_DECLARATIONS$1]
		}]
	}], null, null);
})();
//#endregion
